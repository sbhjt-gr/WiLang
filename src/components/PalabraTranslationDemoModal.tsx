...
const TARGET_LANG_OPTIONS: Array<{ id: TargetLangCode; label: string; flag: string }> = [
  ...
  { id: 'ja', label: 'Japanese', flag: '🇯🇵' },
  { id: 'ko', label: 'Korean', flag: '🇰🇷' },
  { id: 'pt-br', label: 'Portuguese (BR)', flag: '🇧🇷' },
  { id: 'ru', label: 'Russian', flag: '🇷🇺' },
];
...
export const PalabraTranslationDemoModal: React.FC<Props> = ({ visible, onClose }) => {
  ...
  // State
  const [sourceLanguage, setSourceLanguage] = useState<SourceLangCode>('en');
  const [targetLanguage, setTargetLanguage] = useState<TargetLangCode>('es');
